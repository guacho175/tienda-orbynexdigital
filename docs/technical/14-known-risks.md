...
*   **Riesgo**: Si un cliente inicia el pago, reserva stock por 10 minutos y se demora más de ese plazo en el portal del banco, el cron del servidor liberará el stock reservado en caliente. Si el cliente finaliza el pago exitosamente después de este tiempo, Flow confirmará una orden expirada.
