-- Fix create_order_with_stock_reservation output ambiguity after production test.
-- The RETURNING clause must qualify public_lookup_token because the function
-- also returns a column with that name.
